...
export default function Container({
  ...
  useEffect(() => {
    if (canvaRef.current) {
      ...
      if (context) {
        ...
        const letters =
          "00010101010 1001010 100101010010 1001010101 0100 101010101001 010 101010101010";
        ...
        const draw = () => {
          ...
          for (let i = 0; i < drops.length; i++) {
            ...
            drops[i]++;
            if (drops[i] * fontSize > contextHeight && Math.random() > 0.95) {
              drops[i] = 0;
            }
          }
        };
      ...
      if (context) {
        ...
        const renderLines = function () {
          ...
          for (let i = 0; i < contextHeight / 2; i += 1) {
            context.moveTo(0, i * 2 + 0.5);
            context.lineTo(contextWidth, i * 2 + 0.5);
          }
          context.stroke();
        };
  ...
  return (
    <div>
      ...
      <canvas ref={canvaRef} className="matrix-bg"></canvas>
      <div className="temp">
        <div>
          <canvas ref={canvaWakeUp} className="wakeup"></canvas>
          <Navbar />
        </div>
