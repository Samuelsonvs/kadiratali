    ...
    <Container customTitle={"404 – Kadir Atalı"}>
      <div className="flex flex-col justify-center items-start max-w-2xl text-primary mx-auto mb-16">
        <div className="font-bold text-3xl md:text-5xl mb-4">
          <h1 className="leading-snug">A glitch has occured</h1>
          <h1>[code: 404]</h1>
        </div>
        <div className="leading-8">
          <p>
            <b>Boy</b>: Do not try and bend the website. That&#039;s impossible.
            ...
            <br />
            <b>Boy</b>: Then you&#039;ll see, that it is not the website that
